...
electionApp.camerasBtnClickHandler = function(event){
	Array.prototype.slice.call(document.querySelectorAll('.cameras__button')).forEach(function(item) {
		item.classList.remove('button--active');
	});
	var camerasVideoItems = Array.prototype.slice.call(document.querySelectorAll('.cameras__video-item'));
...
document.addEventListener('DOMContentLoaded', function() {
	if (electionApp.currentPage == 'index') {
		...
		Array.prototype.slice.call(document.querySelectorAll('.cameras__buttons')).forEach(function(btn) {
